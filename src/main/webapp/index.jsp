...
<head>
  ...
  <title>ChemBuddy - An Glassware geared towards effective STEM Education</title>
...
<body background="http://www.biobm.com/images/life_science_laboratory_glassware.jpg">
<div class="navbar navbar-inverse navbar-fixed-top">
  <div class="navbar-inner">
    <div class="container">
      <a class="brand" href="#">ChemBuddy - An Glassware geared towards effective STEM Education</a>
    </div>
  </div>
</div>
...
<!--div class="container">
  ...
  <div class="row">
    <div class="span4">
      <h2>ChemBuddy</h2><br/>
	  <b>Instructor Portal:</b>

      <p>Please setup the experiments schedule here. Once entered, they will be available on the google glass devices to be used during the lab session for handsfree and guided laboratory experiments.
   
      <form action="<%= WebUtil.buildUrl(request, "/main") %>" method="post">
        <input type="hidden" name="operation" value="insertItem">
        <textarea class="span4" name="message" style="width: 600px; height: 200px;">Enter Experiments info (as html) for now..</textarea><br/>
