...
public class MirrorClient {
  ...
  //Inserts a list of timeline items into the glass
  public static void insertListTimelineItem(Credential credential, List<TimelineItem> items) throws IOException{
